...
class Window(QWidget):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Property Sheet - FindLine")
        self.resize(480, 320)
    ...
    def createFirstExclusiveGroup(self):
        ...
        radio4 = QRadioButton("Ra&dio button 4")
        radio5 = QRadioButton("Ra&dio button 5")
        radio6 = QRadioButton("Ra&dio button 6")
    ...
    def createSecondExclusiveGroup(self):
        ...
        radio4 = QRadioButton("Radio button 4")
        radio5 = QRadioButton("Radio button 5")
        radio6 = QRadioButton("Radio button 6")
